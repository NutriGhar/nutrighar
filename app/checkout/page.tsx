              ...
              {customer ? (
                ...
                <form onSubmit={handleSendOtp} className="space-y-4 pt-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {authLoading ? 'Sending...' : 'Get SMS OTP →'}
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    disabled={authLoading || phone.length !== 10}
                    className="w-full h-11 bg-emerald-50 hover:bg-emerald-100 border border-emerald-300 text-emerald-800 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-colors disabled:opacity-40 cursor-pointer"
                  >
                  ...
                  <div className="text-center pt-1">
                    {otpChannel === 'sms' ? (
                      ...
                      <button
                        ...
                        disabled={authLoading}
                        className="text-xs text-[#4E652B] font-bold hover:underline inline-flex items-center gap-1.5 cursor-pointer"
                      >
